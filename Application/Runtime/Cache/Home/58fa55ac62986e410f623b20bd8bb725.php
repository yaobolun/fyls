...
<body class="body_head"> 
  ...
  <div style='width:1000px;margin:0 auto;overflow:hidden;'>
    ...
    <dl>
          ...
          <?php if($_COOKIE["zjtr_id"] == null): ?><dd ><a href='/zjtr/Home/Mall/login'>会员登录</a></dd>
          ...
          <a href='/zjtr/Home/Mall/anquan'>登出</a></dd><?php endif; ?>
...
<div class='top2'>
   ...
   <div class='gwc'>
      <div style='margin-right:0%;width:100px'>
      ...
      <?php if($m == 2): ?><img src='/zjtr/Public/images/gwcjs.png' style='width:20.5%;margin-right:5%'><a href='/zjtr/Home/Mall/cart'>
       <?php else: ?>
      <img src='/zjtr/Public/images/gouwc.png' style='width:22%;margin-right:8%'><a href='/zjtr/Home/Mall/cart'><?php endif; ?>
      购物车结算</a></div>
   </div>
</div>
					...
					<div class="pros subpage">
						...
						<?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><style>
							...
							<li class="food<?php echo ($hhh++); ?>" >
								...
								<div class="prosmore hide" style='background-color:#fff;opacity:0.3;/*t透明效果*/'>
								</div>
...
<div class='footer'>
   ...
   <div class='bjp'>
       ...
       <span><img src='/zjtr/Public/images/pz.png'>品质可靠</span>
   </div>
   <div class='f_bottom'>
   <center>
   <p>
