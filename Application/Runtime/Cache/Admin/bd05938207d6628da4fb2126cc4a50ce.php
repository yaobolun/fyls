     ...
     <form action="" method="post" enctype="multipart/form-data">
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_295" id="address" placeholder="密码..." name="address" />
        
       </li>
       <li>
        <span class="item_name" style="width:120px;">收件人：</span>
        <input type="text" class="textbox textbox_295" id="people" placeholder="密码..." name="people" />
        
       </li>
       <li>
        <span class="item_name" style="width:120px;">收件人电话：</span>
        <input type="text" class="textbox textbox_295" id="phone" placeholder="密码..." name="phone" />
