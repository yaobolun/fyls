 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="center" style="text-align: justify;"><?php echo (substr(htmlspecialchars_decode($arr["body"]),0,200)); ?>...</td>
        
        <td class="center">
         <a href="/zjtr/Admin/Top/ab_mod?id=<?php echo ($arr["id"]); ?>" title="编辑" class="link_icon">&#101;</a>
