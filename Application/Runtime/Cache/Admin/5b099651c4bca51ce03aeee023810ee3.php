...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">产品颜色</h2>
       <a href="/zjtr/Admin/Col/col_add" class="fr top_rt_btn add_icon">添加颜色</a>
      </div>
      <table class="table">
       <tr>
        <th>编号</th>
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="center"><?php echo ($arr["col_name"]); ?></td>
        
        <td class="center">
         <a href="/zjtr/Admin/Col/col_mod?id=<?php echo ($arr["col_id"]); ?>" title="编辑" class="link_icon">&#101;</a>
         <a href="/zjtr/Admin/Col/col_del?id=<?php echo ($arr["col_id"]); ?>" title="删除" class="link_icon">&#100;</a>
        </td>
