...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">假条详情</h2>
       <a class="fr top_rt_btn" href="/fyls/Admin/Approval/leave">返回</a>
      </div>
     <section>
     ...
     <table class="layui-table" style="width:900px; height:300px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <?php if(session('administration') == 0): ?><td><button disabled  class="layui-btn layui-btn-primary layui-btn-lg" onclick="yes()">通过</button></td>
            <td>
            <button disabled class="layui-btn layui-btn-primary layui-btn-lg" onclick="Not(<?php echo ($find["id"]); ?>)">残忍拒绝</button>
            </td>
            <?php else: ?>
             <td><button type="button" class="layui-btn layui-btn-primary layui-btn-lg" onclick="yes()">通过</button></td>
            <td>
