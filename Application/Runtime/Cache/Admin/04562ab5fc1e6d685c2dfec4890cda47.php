     ...
     <li>
        <span class="item_name" style="width:120px;">上传图片：</span>
          <label class="uploadImg">
           ...
           <div id="localImag"><img id="preview" src="/zjtr/Public/home/image/card.png" width="500px" /></div>
           <span>上传图片</span>
          </label>
       </li>
       <li>
        <span class="item_name" style="width:120px;">填写链接：</span>
           <input type="text" name="text" class="textbox textbox_295" />
       </li>
