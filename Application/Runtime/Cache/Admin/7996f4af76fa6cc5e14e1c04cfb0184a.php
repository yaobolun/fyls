     ...
     <form action="" method="post"  enctype="multipart/form-data">
      <ul class="ulColumn2">
       <li>
        ...
        <input type="text" class="textbox textbox_295" value="<?php echo ($sel["name"]); ?>" name="name" readonly/> <span style=" color:red">*禁止编辑</span>
         
       </li>
       <li>
        <span class="item_name" style="width:120px;">内容：</span>
        <input type="text" class="textbox textbox_295" value="<?php echo ($sel["emph"]); ?>" name="emph" />
