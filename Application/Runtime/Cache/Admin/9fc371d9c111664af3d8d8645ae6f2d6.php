...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <form action="" method="post" enctype="multipart/form-data">
      ...
      <tr>
        <th>日期</th>
        <td><input type="text" class="textbox textbox_295" placeholder="到账的年月日" name="qualifications_date" required="required"/></td>
        <th>市场部客服</th>
      ...
      <tr>
        ...
        <th>本次到账日期</th>
        <td><input type="text" class="textbox textbox_295" placeholder="资金到账的年月日时分" name="qualifications_arrival" required="required"/></td>
      </tr>
      <tr>
        <th>合同价格</th>
