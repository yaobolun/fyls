 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <?php if(is_array($renshi)): $i = 0; $__LIST__ = $renshi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$renshi): $mod = ($i % 2 );++$i;?><tr>
        <td class="center"><?php echo ($renshi["refund_applicant"]); ?></td>
        <td class="center"><?php echo ($renshi["refund_match"]); ?></td>
        <td class="center"><?php echo ($renshi["refund_equip"]); ?></td>
        <td class="center flow" title="<?php echo ($renshi["refund_contract"]); ?>"><?php echo ($renshi["refund_contract"]); ?></td>
        <td class="center flow" title="<?php echo ($renshi["refund_remarks"]); ?>"><?php echo ($renshi["refund_remarks"]); ?></td>
        <td class="center">
       ...
       <?php if(is_array($guanli)): $i = 0; $__LIST__ = $guanli;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanli): $mod = ($i % 2 );++$i;?><tr>
        <td class="center"><?php echo ($guanli["refund_applicant"]); ?></td>
        <td class="center"><?php echo ($guanli["refund_match"]); ?></td>
        <td class="center"><?php echo ($guanli["refund_equip"]); ?></td>
        <td class="center flow" title="<?php echo ($guanli["refund_contract"]); ?>"><?php echo ($guanli["refund_contract"]); ?></td>
        <td class="center flow" title="<?php echo ($guanli["refund_remarks"]); ?>"><?php echo ($guanli["refund_remarks"]); ?></td>
        <td class="center">
