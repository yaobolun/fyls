...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       ...
       <a href="/fyls/Admin/Express/add" class="fr top_rt_btn add_icon">申请快递</a>
      </div>
      <table class="table">
       <tr>
        <th>编号</th>
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="center"><?php echo ($arr["address"]); ?></td>
        <td class="center"><?php echo ($arr["name"]); ?></td>
        <td class="center"><?php echo ($arr["people"]); ?></td>
        <td class="center"><?php echo ($arr["phone"]); ?></td>
        <td class="center" title="<?php echo ($arr["beizhu"]); ?>"><?php if (strlen($arr['beizhu'])>5) $arr['beizhu']=substr($arr['beizhu'],0,5) . '...';echo $arr['beizhu'];?></td>
        <td class="center"></td>
