...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">banner图片列表</h2>
       <a href="/zjtr/Admin/Top/banner_add?type=1" class="fr top_rt_btn add_icon">添加电脑官网图片</a>
       <a href="/zjtr/Admin/Top/banner_add?type=2" class="fr top_rt_btn add_icon">添加手机图片</a>
       <a href="/zjtr/Admin/Top/banner_add?type=3" class="fr top_rt_btn add_icon">添加电脑商城图片</a>
      </div>
      <table class="table">
       <tr>
        <th>编号</th>
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="center"><img src="/zjtr/Public/<?php echo ($arr["photo"]); ?>" style="width:250px"></td>
        <td class="center"><?php echo ($arr["url"]); ?></td>
        <td class="center">
           <?php if($arr["web"] == 1): ?>电脑官网<?php endif; ?>
           <?php if($arr["web"] == 2): ?>手机<?php endif; ?>
           <?php if($arr["web"] == 3): ?>电脑商城<?php endif; ?>
        </td>
        <td class="center">
         <a href="/zjtr/Admin/Top/banner_mod?id=<?php echo ($arr["id"]); ?>" title="编辑" class="link_icon">&#101;</a>
         <a href="/zjtr/Admin/Top/banner_del?id=<?php echo ($arr["id"]); ?>" title="删除" class="link_icon">&#100;</a>
        </td>
