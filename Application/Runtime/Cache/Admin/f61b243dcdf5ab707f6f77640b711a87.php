...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <form action="" method="post"  enctype="multipart/form-data">
      ...
      <tr>
        <th>到账时间</th>
        <td><input type="text" class="textbox textbox_295" placeholder="到账时间" name="arrival_time" value="<?php echo ($sel["arrival_time"]); ?>" required="required"/></td>
        <th>到账金额</th>
      ...
      <tr>
        <th>企业价格</th>
        <td><input type="text" class="textbox textbox_295" placeholder="企业注册资金" name="arrival_enterprise" value="<?php echo ($sel["arrival_enterprise"]); ?>" required="required"/></td>
        <th>签约年限</th>
        <td><input type="text" class="textbox textbox_295" placeholder="合同签约年份" name="arrival_contrac" value="<?php echo ($sel["arrival_contrac"]); ?>" required="required"/></td>
      </tr>
      <tr>
        <th>配备人才</th>
        <td><input type="text" class="textbox textbox_295" placeholder="姓名" name="arrival_qualified" value="<?php echo ($sel["arrival_qualified"]); ?>" required="required"/></td>
        <th>级别</th>
        <td><input type="text" class="textbox textbox_295" placeholder="申请人所在公司级别" name="arrival_level" value="<?php echo ($sel["arrival_level"]); ?>" required="required"/></td>
      </tr>
      <tr>
        <th>专业</th>
        <td><input type="text" class="textbox textbox_295" placeholder="专业" name="arrival_major" value="<?php echo ($sel["arrival_major"]); ?>" required="required"/></td>
        <th>人才价格</th>
        <td><input type="text" class="textbox textbox_295" placeholder="人才价格" name="arrival_talent" value="<?php echo ($sel["arrival_talent"]); ?>" required="required"/></td>
      </tr>
      <tr>
        <th>客服</th>
        <td><input type="text" class="textbox textbox_295" placeholder="客服" name="arrival_customer" value="<?php echo ($sel["arrival_customer"]); ?>" required="required"/></td>
      </tr>
        <!-- <li>
