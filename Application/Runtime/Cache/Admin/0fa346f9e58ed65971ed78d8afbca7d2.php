...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">支付修改</h2>
       <a class="fr top_rt_btn" href="/SHT/Admin/Pay/pay">返回支付方式列表</a>
      </div>
     <section>
     <form action="" method="post"  enctype="multipart/form-data">
      <ul class="ulColumn2">
       <li>
        ...
        <input type="text" class="textbox textbox_295" value="<?php echo ($sel["name"]); ?>" name="name" />
         
       </li>
       <li>
        <span class="item_name" style="width:120px;">支付接口：</span>
        <input type="text" class="textbox textbox_295" value="<?php echo ($sel["jiekou"]); ?>" name="jiekou" />
