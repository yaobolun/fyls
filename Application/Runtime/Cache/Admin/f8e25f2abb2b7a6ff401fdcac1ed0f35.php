 ...
 <div class="rt_content">
     ...
     <form action="" method="post"  enctype="multipart/form-data">
      ...
      <tr>
        ...
        <th>级别</th>
        <td><input type="text" class="textbox textbox_295" placeholder="级别" name="requipment_level" value="<?php echo ($sel["requipment_level"]); ?>" required="required"/></td>
      </tr>
      <tr>
        <th>专业</th>
      ...
      <tr>
        <th>客服</th>
        <td><input type="text" class="textbox textbox_295" placeholder="客服" name="requipment_customer" value="<?php echo ($sel["requipment_customer"]); ?>" required="required"/></td>
      </tr>
       </table>
