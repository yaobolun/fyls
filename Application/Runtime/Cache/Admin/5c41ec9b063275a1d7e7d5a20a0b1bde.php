 ...
 <div class="rt_content">
     ...
     <table class="layui-table" style="width:900px; height:400px;">
        ...
        <tbody>
          ...
          <tr>
          <td colspan="2"></td>
            <td><center><button type="button" class="layui-btn layui-btn-primary layui-btn-lg" onclick="yes()">确认</button></center></td>
            <td>
                <center><button type="button" class="layui-btn layui-btn-primary layui-btn-lg" onclick="Not(<?php echo ($expre_info["id"]); ?>)">残忍拒绝</button></center>
            </td>
          </tr>
        </tbody>
      </table>
