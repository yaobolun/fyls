     ...
     <form action="/fyls/Admin/Leave/doadd_leave" method="post">
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <textarea required="required" style="height: 100px" type="text" class="textbox textbox_295" placeholder="请假理由..." name="leave_reason"></textarea>
       </li>
       <li>
          <span class="item_name" style="width: 200px;" >开始日期:</span>
          <div class="layui-input-inline">
            <input required="required" type="text" name="start_time" class="textbox textbox_295" id="test5" placeholder="请假开始日期">
          </div>
       </li>
       <li>
          <span class="item_name" style="width: 200px;" >结束日期:</span>
          <div class="layui-input-inline">
            <input required="required" type="text" name="end_time" class="textbox textbox_295" id="test1" placeholder="请假结束日期">
          </div>
       </li>
       <li>
        ...
        <select name="aid" style='width:307px;height:38px;border: 1px #4fa3d3 solid;'>
          <option>--请选择--</option>
          <?php if(is_array($user)): foreach($user as $key=>$user): ?><option required="required" value="<?php echo ($user["id"]); ?>">
                    <?php echo ($user["name"]); ?>
