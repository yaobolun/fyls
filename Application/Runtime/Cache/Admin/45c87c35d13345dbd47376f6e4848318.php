...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">快递申请</h2>
       <a class="fr top_rt_btn" href="/fyls/Admin/Expre/express">返回</a>
      </div>
     <section>
     <form action="/fyls/Admin/Expre/expre_info_add" method="post">
      <ul class="ulColumn2">
      <li>
        <span class="item_name" style="width:120px;">寄件人：</span>
        <input type="text" readonly class="textbox textbox_295" value="<?php echo ($arr["name"]); ?>"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">收件人：</span>
        <input type="text" readonly class="textbox textbox_295" value="<?php echo ($arr["addressee"]); ?>"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">电话：</span>
        <input type="text" readonly class="textbox textbox_295" value="<?php echo ($arr["tel"]); ?>"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">快递物品：</span>
        <input type="text" readonly class="textbox textbox_295" value="<?php echo ($arr["goods"]); ?>" />
       </li>
       <li>
        <span class="item_name" style="width:120px;">快递地址：</span>
        <input type="text" readonly class="textbox textbox_295" value="<?php echo ($arr["address"]); ?>" />
       </li>
       <li>
        <span class="item_name" style="width:120px;">备注：</span>
        <textarea readonly class="textbox textbox_295" style="height: 60px"><?php echo ($arr["remarks"]); ?></textarea>
         </li>
         <li>
        <span class="item_name" style="width:120px;">到货公司名称：</span>
        <input type="text" required="required" class="textbox textbox_295" name="company_name" />
       </li>
       <li>
        <span class="item_name" style="width:120px;">快递单号：</span>
        <input type="text" required="required" class="textbox textbox_295"  name="number" />
       </li>
