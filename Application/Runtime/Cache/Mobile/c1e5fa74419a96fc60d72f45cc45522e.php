...
<img src='/zjtr/Public/images/m/lxwm.jpg' style='width:100%'>
...
<div class='mindex_content'>
     ...
     <div class='m_gsjj' style='background:#FAFAFA;padding:2%'>
         <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><h4 style='text-align:center'><?php echo ($data["title"]); ?></h4>
                <div id='editor<?php echo ($e++); ?>'></div>
