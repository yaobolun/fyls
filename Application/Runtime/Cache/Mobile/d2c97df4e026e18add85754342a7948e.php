...
<body class="body_head"> 
 <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style='background:#37ADE7;'>
    ...
    <div class="collapse navbar-collapse" id="example-navbar-collapse">
        <ul class="nav navbar-nav">
            <li class="actives"><a href="/zjtr/Mobile/Index/index" style='color:#fff'>首页</a></li>
            <li><a href="/zjtr/Mobile/Index/jour" style='color:#fff'>新闻中心</a></li>
          
            <li><a href="/zjtr/Mobile/Index/classic" style='color:#fff'>经典案例</a></li>
            <li><a href="/zjtr/Mobile/Index/win" style='color:#fff'>合作共赢</a></li>
         
            <li><a href="/zjtr/Mobile/Index/contact" style='color:#fff'>联系我们</a></li>
...
.m_cp_title{
  width:30%;float:left;text-align:center;font-size:16px;font-weight: bold;height:9%;padding:5% 0;
}
.m_cp_buy{
  width:25%;float:right;height:9%;padding:4.5% 0;
}
.m_cp_bl,.m_cp_br{
  border:0;width:25%;background:#F2F2F2;color:#CCCCCC;font-size:16px;
}
.m_cp_bl{
  margin-right:2px
}
...
.m_cp_sum{
  width:25%;border:0;background:#F5F5F5;text-align:center
}
.m_cp_jg{
  width:30%;float:left;text-align:center;color:red;font-weight: bold;height:9%
}
.m_cp_gwc{
  width:25%;float:right;height:9%
}
.m_cp_gwc a{
  background:#008CD6;color:#fff;padding:8%
}
.m_left{
...
<div class='mindex_content'>
     ...
     <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><dl class='m_cplist'>
     <a href='/zjtr/Mobile/Mall/details'>
       <dt class='m_cp_img'><img src='/zjtr/Public/<?php echo ($data["diagram"]); ?>'></dt>
       <dd class='m_cp_title'><?php echo ($data["title"]); ?></dd>
        </a>
       <dd class='m_cp_buy'> 
         <span data-box='buy'>
         <button type='button' class='m_cp_bl'>-</button><input id="phone" type="text"    min='1' max='10' step='1' pattern='[0-9]*' value='0' name='BuyNum' readonly class='m_cp_sum'/><button type='button' class='m_cp_br'>+</button>
         </span>
       </dd>
        <a href='/zjtr/Mobile/Mall/details'>
       <dd class='m_cp_jg'>￥<?php echo ($data["price"]); ?>/顶</dd>
       </a>
       <dd class='m_cp_gwc' ><a href='#'>加入购物车</a></dd>
...
<div class='footer'>
     ...
     <div class='f_dh navbar-fixed-bottom'>
           ...
           <a href='/zjtr/Mobile/Mall/cart'> <p><?php if($g == 1): ?><img src='/zjtr/Public/images/m/xgwc.png'><?php else: ?><img src='/zjtr/Public/images/m/gwc.png'><?php endif; ?></p></a>
           <a href='#'> <p><img src='/zjtr/Public/images/m/wd.png'></p></a>
      </div>
</div>
</body>
</html>