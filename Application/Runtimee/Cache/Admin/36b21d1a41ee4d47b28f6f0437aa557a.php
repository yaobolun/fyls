     ...
     <table class="layui-table" style="width:900px; height:300px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <?php if($_SESSION['administration'] != 0): ?><td>
            ...
            <?php else: ?>
            <td>
              <button type="button" disabled class="layui-btn layui-btn-primary layui-btn-lg" onclick="yes()">通过</button></td>
            <td>
              <button type="button" disabled class="layui-btn layui-btn-primary layui-btn-lg" onclick="Not(<?php echo ($find["id"]); ?>)">残忍拒绝</button>
            </td><?php endif; ?>
