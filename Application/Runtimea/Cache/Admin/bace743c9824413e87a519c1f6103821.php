 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <?php if(is_array($renshi)): $i = 0; $__LIST__ = $renshi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$renshi): $mod = ($i % 2 );++$i;?><tr>
        <td class="center"><?php echo ($renshi["voucher_applicant"]); ?></td>
        <td class="center"><?php echo ($renshi["voucher_account"]); ?></td>
        <td class="center"><?php echo ($renshi["voucher_equip"]); ?></td>
        <td class="center flow" title="<?php echo ($renshi["voucher_contract"]); ?>"><?php echo ($renshi["voucher_contract"]); ?></td>
        <td class="center flow" title="<?php echo ($renshi["voucher_amount"]); ?>"><?php echo ($renshi["voucher_amount"]); ?></td>
        <td class="center">
       ...
       <?php if(is_array($guanli)): $i = 0; $__LIST__ = $guanli;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$guanli): $mod = ($i % 2 );++$i;?><tr>
        <td class="center"><?php echo ($guanli["voucher_applicant"]); ?></td>
        <td class="center"><?php echo ($guanli["voucher_account"]); ?></td>
        <td class="center"><?php echo ($guanli["voucher_equip"]); ?></td>
        <td class="center flow" title="<?php echo ($guanli["voucher_contract"]); ?>"><?php echo ($guanli["voucher_contract"]); ?></td>
        <td class="center flow" title="<?php echo ($guanli["voucher_amount"]); ?>"><?php echo ($guanli["voucher_amount"]); ?></td>
        <td class="center">
