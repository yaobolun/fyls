  ...
  <center>
   <form action='' method='post'>
     <div class='zm'>
          ...
          <div>
              <input type='password' name='Pass_new' id='passnew' placeholder="再次确认密码" style='margin-left:10%;color:#000' >
          </div>
           <div>
              <img src='/zjtr/Public/images/dh.png'><input type='text' id='phone' name='Phone' placeholder="请输入您常用的手机号码" style='color:#000'>
          </div>
