...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       ...
       <a href="/zjtr/Admin/New/news_add" class="fr top_rt_btn add_icon">添加单个产品</a>
      ...
      <table class="table">
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td ><?php echo ($arr["price"]); ?>/<?php echo ($arr["danwei"]); ?></td>
        <td >
            <?php if(is_array($arr["diagram"])): $i = 0; $__LIST__ = $arr["diagram"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?><img src='/zjtr/Public/<?php echo ($img); ?>' style='width:60px;height:60px'>&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>  
        </td>
        <td ><?php echo ($arr["bought"]); ?></td>  
        <td class="center">
         <a href="/zjtr/Admin/New/news_mod?id=<?php echo ($arr["id"]); ?>" title="编辑" class="link_icon">&#101;</a>
         <a href="/zjtr/Admin/New/news_del?id=<?php echo ($arr["id"]); ?>" title="删除" class="link_icon">&#100;</a>
        </td>
