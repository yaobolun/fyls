...
<div class='about_content'>
 <div style='width:1200px;margin:0 auto;margin-top:40px'>
   ...
   <div class='about_right'>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><a href='/zjtr/Home/Index/c_jour?active=<?php echo ($n); ?>&id=<?php echo ($data["type_id"]); ?>'>
             <dl>
               <dt><img src='/zjtr/Public/<?php echo ($data["n_photo"]); ?>'></dt>
               <dd class='about_right_content_title'><?php echo ($data["title"]); ?></dd>
               <dd class='about_right_content_brief'><?php echo ($data["abstract"]); ?></dd>
             </dl>
