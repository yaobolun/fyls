...
.baocun{
    width:75px;text-align:center;background:#008CD6;color:#fff;padding:5px;font-size:16px;display: block;float:left;margin-left:200px
}
*{margin:0;padding:0;list-style-type:none;}
a,img{border:0;}
body{font:12px/180% Arial, Helvetica, sans-serif, "新宋体";}
...
<div class='product_content'>
	...
	<div class='pc_right' id='xx'>
           <div class='pcr_left' style='float:left'>
           
           <?php if($data["photo"] != null): ?><img src="/zjtr/Public/<?php echo ($data["photo"]); ?>" width='100' height='100'>
           <?php else: ?>
           <img src="/zjtr/Public/images/zwtx.jpg" width='100' height='100'><?php endif; ?>
           </div>
           <div class='pcr_right' style='float:right'>
                 <p><?php echo ($data["name"]); ?></p>
                 <p>性别：<?php echo ($data["sex"]); ?></p>
                 <p>电话：<?php echo ($data["phone"]); ?></p>
                 <p>邮箱：<?php echo ($data["email"]); ?></p>
                 <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><p>收货地址：<?php echo ($a["a_address"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>   
                 <div>
                      <a href='#' class='xgxx' onclick='xxk1()' >修改信息</a>
                      <a href='#' class='baocun' >保存</a>
                 </div>
           </div>
	</div>
	<div class='pc_right' hidden id='bao'>
	  <form action='/zjtr/Home/My/up' method='post' enctype="multipart/form-data">
           <div class='pcr_left' style='float:left;width:150px'>
           <input type='hidden' value='<?php echo ($data["photo"]); ?>' name='o_photo'>
           <?php if($data["photo"] != null): ?><img id='addfiles' src='/zjtr/Public/<?php echo ($data["photo"]); ?>' num='1' width='100' height="100" onclick="addfile(this)">
           <?php else: ?>
           <img id='addfiles' src='/zjtr/Public/Images/zwtx.jpg' num='1' width='100' height="100" onclick="addfile(this)"><?php endif; ?>
          <br/><br/>
           ...
           <div class='pcr_right'  style='float:right'>
                 ...
                 <p>邮箱：<input type='text' name='Email' value='<?php echo ($data["email"]); ?>'></p>
                 <div>
