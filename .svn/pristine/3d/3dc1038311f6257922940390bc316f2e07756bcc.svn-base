...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">栏目列表</h2>
       <!-- <a href="/zjtr/Admin/Top/banner_add" class="fr top_rt_btn add_icon">添加图片</a> -->
      </div>
      <table class="table">
       <tr>
        <th>编号</th>
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="center"><img src="/zjtr/Public/<?php echo ($arr["photo"]); ?>" style="width:20px"></td>
        <td class="center"><img src="/zjtr/Public/<?php echo ($arr["photos"]); ?>" style="width:20px"></td>
        <td class="center"><img src="/zjtr/Public/<?php echo ($arr["banner"]); ?>" style="width:100%;"></td>
        <td class="center"><?php echo ($arr["type"]); ?></td>
        <td class="center"><?php echo ($arr["phrase"]); ?></td>
        <td class="center">
         <a href="/zjtr/Admin/Lanmu/lanmu_mod?id=<?php echo ($arr["id"]); ?>" title="编辑" class="link_icon">&#101;</a><!-- 
         <a href="/zjtr/Admin/Lanmu/lanmu_del?id=<?php echo ($arr["id"]); ?>" title="删除" class="link_icon">&#100;</a> -->
        </td>
