...
<div class='product_content'>
	...
	<div class='pc_right'  id='bao'>
	  <form action='/zjtr/Home/My/upaddress' method='post' enctype="multipart/form-data">

           <div class='pcr_right'  style='float:left'>
           <input type='hidden' value='<?php echo ($data["a_id"]); ?>' name='id'>
                 <p>收货地址：<input type='text' name='a_address' value='<?php echo ($data["a_address"]); ?>'></p>
