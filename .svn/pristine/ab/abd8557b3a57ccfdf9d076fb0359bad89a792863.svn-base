...
.index_rmsp .cjrm4,.cjrm5,.cjrm7,.cjrm8{
	background:#F3F3F3;
	width:360px;
	padding: 1%;
	overflow: hidden;
	float: left;
	margin:1% 5% 20PX 0%;
	box-shadow: 0px 2px 1px #888888;/*边框阴影效果*/
}
.index_rmsp .cjrm6,.cjrm9{
	background:#F3F3F3;
	width:360px;
	padding: 1%;
	overflow: hidden;
...
.index_rmsp .djgm a{
  ...
  <style type="text/css">
    *{margin:0;padding:0;list-style-type:none;}
    a,img{border:0;}
    /* flexslider */
    .flexslider{position:relative;height:522px;overflow:hidden;/*background:url(/zjtr/Public/images/loading.gif) 50% no-repeat;*/}
    ...
    .flex-direction-nav{position:absolute;z-index:9999;width:1300px;top:45%;left: 50%;margin-left: -650px;  /*此处的负值是宽度的一半*/ }
    .flex-direction-nav li a{display:block;width:50px;height:50px;overflow:hidden;cursor:pointer;position:absolute;}
    /*.flex-direction-nav li a.flex-prev:hover{left:0%;background:url(/zjtr/Public/images/prev.png) center center no-repeat;}
    .flex-direction-nav li a.flex-next:hover{right:1%;background:url(/zjtr/Public/images/next.png) center center no-repeat;}

    .flex-direction-nav li a.flex-prev{left:0%;background:url(/zjtr/Public/images/prev1.png) center center no-repeat;background-size:50px 50px;}
    .flex-direction-nav li a.flex-next{right:1%;background:url(/zjtr/Public/images/next1.png) center center no-repeat;background-size:50px 50px;}*/
  </style>
<div class="jq22-container">

    <div class="flexslider"  style='width:100%'>
      <ul class="slides">
       <?php if(is_array($ban)): $i = 0; $__LIST__ = $ban;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ban): $mod = ($i % 2 );++$i;?><li style="background:url(/zjtr/Public/<?php echo ($ban["photo"]); ?>) no-repeat;background-size:100% 522px"></li><?php endforeach; endif; else: echo "" ;endif; ?>  
      </ul>
    </div>
...
<!-- <img src='/zjtr/Public/images/scsy.jpg' class='banner'> -->
 <div class='index_sp'>
     <ul>
       <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li class='san<?php echo ($san++); ?>'>
            <a href='/zjtr/Home/Mall/details?active=<?php echo ($n); ?>&id=<?php echo ($data["id"]); ?>'><img src='/zjtr/Public/<?php echo ($data["diagram"]); ?>'></a>
         </li><?php endforeach; endif; else: echo "" ;endif; ?>  
        
     </ul>
 </div>
   <h1>超级热卖</h1>
  <div class='index_rmsp'>
  <?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?><dl class='cjrm<?php echo ($san++); ?>'>
        <a href='/zjtr/Home/Mall/details?active=<?php echo ($n); ?>&id=<?php echo ($hot["id"]); ?>'><dt><img src='/zjtr/Public/<?php echo ($hot["diagram"]); ?>'></dt>
        <dd class='ming'><?php echo ($hot["title"]); ?></dd>
        <dd class='jg'>￥<?php echo ($hot["price"]); ?>/<?php echo ($hot["danwei"]); ?></dd></a>
        <dd class='djgm'><a href='/zjtr/Home/Mall/details?active=<?php echo ($n); ?>&id=<?php echo ($hot["id"]); ?>'>点击购买</a></dd>
