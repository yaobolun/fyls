...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">图片修改</h2>
       <a class="fr top_rt_btn" href="/Admin/Top/client">返回</a>
      </div>
     <section>
     <form action="" method="post"  enctype="multipart/form-data">
      ...
      <li>
        ...
        <input type="text" name="name" class="textbox textbox_295" value="<?php echo ($sel["name"]); ?>">
      </li>
     <li>
        <span class="item_name" style="width:120px;">修改图片：</span>
        <input type="hidden" name="o_photo" value="<?php echo ($sel["photo"]); ?>" />
        <img src="/Public/<?php echo ($sel["photo"]); ?>" style=" width:150px"/>
