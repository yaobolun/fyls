...
<div class='mindex_content'>
    ...
    <input type='hidden' value='<?php echo ($data["id"]); ?>' name='spid'>
     ...
     <a href='/zjtr/Mobile/Mall/details?id=<?php echo ($data["id"]); ?>'>
       ...
       <dd class='m_cp_buy'> 
         <span data-box='buy'>
         <button type='button' class='m_cp_bl'>-</button><input id="<?php echo ($data["id"]); ?>" type="text"    min='1' max='10' step='1' pattern='[0-9]*' value='0' name='BuyNum' readonly class='m_cp_sum'/><button type='button' class='m_cp_br'>+</button>
         </span>
       </dd>
        <a href='/zjtr/Mobile/Mall/details?id=<?php echo ($data["id"]); ?>'>
       <dd class='m_cp_jg'>￥<?php echo ($data["price"]); ?>/顶</dd>
       </a>
       <dd class='m_cp_gwc' ><input type='submit' name='jrgwc' value='加入购物车' onclick='return num(<?php echo ($data["id"]); ?>);'></dd>
     </dl>
