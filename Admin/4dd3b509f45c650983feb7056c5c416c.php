...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">修改</h2>
       <a class="fr top_rt_btn" href="/zjtr/Admin/Top/ab">返回</a>
      </div>
     <section>
     <form action="" method="post"  enctype="multipart/form-data">
      ...
      <li>
        ...
        <input type="text" name="title" class="textbox textbox_295" value="<?php echo ($sel["title"]); ?>">
      </li>
    
      <li>
        <span class="item_name" style="width:120px;">内容：</span>
        <script id="editor" type="text/plain" name="body" style="width:1024px;height:500px;margin-left:120px;margin-top:0;"></script>
        <div hidden="hidden" id="content"><?php echo (htmlspecialchars_decode($sel["body"])); ?></div>
