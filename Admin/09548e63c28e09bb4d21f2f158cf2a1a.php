 ...
 <div class="rt_content">
     ...
     <form action="" method="post" enctype="multipart/form-data">
      <ul class="ulColumn2">
       ...
       <li>
        <span class="item_name" style="width:120px;">缩略 图：</span>
          <label class="uploadImg">

            <input type="file" name="photo1" id="doc" class="sr-only" onchange="javascript:setImagePreview();"/>
           <div id="localImag"><img id="preview" src="/zjtr/Public/home/image/card.png" width="100px" /></div>
...
return true;
      ...
      <li>
        <span class="item_name" style="width:120px;">类别:</span>
         ...
         <select name="n_id" class="select">
            <option value="">----请选择----</option>
                ...
                <?php if(is_array($report2)): $i = 0; $__LIST__ = $report2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($voo["id"]); ?>"><?php echo ($voo["type"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
       ...
       <li>
        ...
        <input type="hidden" name="top_id" value="1" />
