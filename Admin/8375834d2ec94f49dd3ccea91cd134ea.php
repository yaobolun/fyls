...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">修改</h2>
       <a class="fr top_rt_btn" href="/zjtr/Admin/Top/rl">返回</a>
      </div>
     <section>
     <form action="" method="post"  enctype="multipart/form-data">
      ...
      <li>
        ...
        <lable>
          <input type="text" id="message" class="textbox textbox_295" name="title" value="<?php echo ($sel["title"]); ?>" />
     ...
     <li>
        ...
        <script id="editor" type="text/plain" name="neirong" style="width:1024px;height:500px;margin-left:120px;margin-top:0;"></script>
        <div hidden="hidden" id="content"><?php echo (htmlspecialchars_decode($sel["neirong"])); ?></div>
