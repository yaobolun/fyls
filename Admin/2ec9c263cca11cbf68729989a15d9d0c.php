...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">Report Licenses</h2>
      </div>
      <table class="table">
       <tr>
        <th>编号</th>
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        <td class="center"><?php echo ($key+1); ?></td>
         <td class="center"><?php echo (htmlspecialchars_decode($arr["title"])); ?> </td>
        <td class="center"><?php echo (substr(htmlspecialchars_decode($arr["neirong"]),0,400)); ?>...</td>
        
        <td class="center"><a href="/zjtr/Admin/Top/rl_mod?id=<?php echo ($arr["id"]); ?>" title="编辑" class="link_icon">&#101;</a>
        </td>
