     ...
     <form action="" method="post"  enctype="multipart/form-data">
      <ul class="ulColumn2">
       <li>
        ...
        <input type="text" class="textbox textbox_295" placeholder="颜色..." name="col_name" value="<?php echo ($sel["col_name"]); ?>"/>
         
       </li>
      <input type="hidden" name='col_id' value="<?php echo ($sel["col_id"]); ?>"/>
       <li>
