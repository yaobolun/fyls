 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="center"><?php if($arr["photo"] != null): ?><img src='/zjtr/Public/<?php echo ($arr["photo"]); ?>' width='50' height='50'><?php else: ?>暂无头像<?php endif; ?></td>
        
        <td class="center"><?php echo ($arr["phone"]); ?></td>
        <td class="center"><?php if(is_array($arr["address"])): $i = 0; $__LIST__ = $arr["address"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$address): $mod = ($i % 2 );++$i; echo ($address); ?><br><?php endforeach; endif; else: echo "" ;endif; if($arr["address"] == null): ?>未添加地址<?php endif; ?></td>
        
        <td class="center">
         <a href="/zjtr/Admin/Member/member_mod?id=<?php echo ($arr["id"]); ?>" title="编辑" class="link_icon">&#101;</a><!-- 
         <a href="/zjtr/Admin/Member/member_del?id=<?php echo ($arr["id"]); ?>" title="删除" class="link_icon">&#100;</a> -->
        </td>
